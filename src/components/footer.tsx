    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/locations" className="hover:text-gray-400">Locations</a></li>
              <li><a href="/careers" className="hover:text-gray-400">Careers</a></li>
              <li><a href="/rewards" className="hover:text-gray-400">Rewards</a></li>
              <li><a href="/our-story" className="hover:text-gray-400">Our Story</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p>&amp;copy; {new Date().getFullYear()} PFG. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
